...
#define MERGE_TREE_SETTINGS(M, ALIAS) \
    ...
    M(Bool, add_implicit_sign_column_constraint_for_collapsing_engine, true, "If true, add implicit constraint for sign column for CollapsingMergeTree engine.", 0) \
